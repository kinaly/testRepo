...
output += "</p>\n\t<p class=\"swatch__contrast switchable-info__item -white\">";
...
output += "</p>\n\t<p class=\"swatch__contrast switchable-info__item -black\">";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "swatch")),"contrastToBlack"), env.opts.autoescape);
